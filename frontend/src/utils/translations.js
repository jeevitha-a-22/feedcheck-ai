...
export const TRANSLATIONS = {
  en: {
    ...
    new_test: {
      ...
      error_image: 'Please upload a sample image.',
      error_moisture: 'Please enter moisture content.',
      error_ph: 'Please enter silage pH.',
      error_temp: 'Please enter core temperature.'
    },
    feed_types: {
  ...
  kn: {
    ...
    new_test: {
      ...
      error_image: 'ದಯವಿಟ್ಟು ಮಾದರಿ ಚಿತ್ರವನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.',
      error_moisture: 'ದಯವಿಟ್ಟು ತೇವಾಂಶ ಪ್ರಮಾಣವನ್ನು ನಮೂದಿಸಿ.',
      error_ph: 'ದಯವಿಟ್ಟು ಸೈಲೇಜ್ pH ಅನ್ನು ನಮೂದಿಸಿ.',
      error_temp: 'ದಯವಿಟ್ಟು ಕೋರ್ ತಾಪಮಾನವನ್ನು ನಮೂದಿಸಿ.'
    },
    feed_types: {
  ...
  hi: {
    ...
    new_test: {
      ...
      error_image: 'कृपया नमूना छवि अपलोड करें।',
      error_moisture: 'कृपया नमी की मात्रा दर्ज करें।',
      error_ph: 'कृपया साइलेज pH दर्ज करें।',
      error_temp: 'कृपया कोर तापमान दर्ज करें।'
    },
    feed_types: {
